...
public class ClienteController {
     ...
     * @param clientes Repositório de clientes.
     */
     ...
     * @return Uma string indicando o status do cadastro do cliente.
     */
    ...
    /**
     * Este método auxiliar é responsável por cadastrar um cliente.
     ...
     * @param novoDocumento Novo documento do cliente.
     * @return Uma string indicando o status da alteração do cliente.
     */
     ...
     * @param clienteAtual Cliente atual.
     * @return Verdadeiro se o CPF/CNPJ estiver disponível, falso caso contrário.
     */
